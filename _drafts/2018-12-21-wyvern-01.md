...
3. Implement the first pass of the assembler for translation into an intermediate file. Define an intermediate file format.
4. Implement the second pass of the assembler that will create the linkable object file. Define an object file format.
