...
### Prelude
[Last time][1], I designed simple models for representing three parts of the *Wasp*: RAM, data output, and address output. Then put them together in a first simple model of the *Wasp*.
...
### Conclusion
I laid out some basics for taking the next design steps. Two of the three new modules have been implemented here. Next time, I'll implement the missing Address Counter. Once that is done, I'll put them together to create the improved version of the *Wasp*.
