...
Also, I used a mix of 2- and 3-input gates in the schematic above. If you were to build this circuit from [74-series logic chips][13], you'd also need to adjust for [propagation delay][15] and [structural hazards][16]. You'd probably also split or merge certain signals to optimize for gate and/or chip count, respectively. There are some duplicate gates/signals in the circuit above, too.
