...
feature:    /assets/snesaa/09/saa09_featurecard.png
published:  true
comments:   true
---
...
<figure>
    <a href="{{ "/assets/snesaa/09/saa09_titlecard.gif" | uri_escape | absolute_url }}">
        <img src="{{ "/assets/snesaa/09/saa09_titlecard.gif" | uri_escape | absolute_url }}">
    </a>
