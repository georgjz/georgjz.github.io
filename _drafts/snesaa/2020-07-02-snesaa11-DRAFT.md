...
feature:    /assets/snesaa/11/saa11_featurecard.png
published:  true
comments:   true
---
...
<figure>
    <a href="{{ "/assets/snesaa/11/saa11_titlecard.gif" | uri_escape | absolute_url }}">
        <img src="{{ "/assets/snesaa/11/saa11_titlecard.gif" | uri_escape | absolute_url }}">
    </a>
