...
feature:    /assets/snesaa/13/snesaa13_featurecard.png
published:  true
comments:   true
---
...
<figure>
    <a href="{{ "/assets/snesaa/13/snesaa13_titlecard.gif" | uri_escape | absolute_url }}">
        <img src="{{ "/assets/snesaa/13/snesaa13_titlecard.gif" | uri_escape | absolute_url }}">
    </a>
