...
Finally, let's test your knowledge with some simple programming challenges. Clone this repository and `cd` into the subdirectory `part01`. There, you'll find three files:
...
* The GForth User Manual has a good tutorial you can follow, [found here](https://www.complang.tuwien.ac.at/forth/gforth/Docs-html/Tutorial.html#Tutorial)
