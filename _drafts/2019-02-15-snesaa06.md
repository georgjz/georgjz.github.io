---
layout:     post
title:      "SNES Assembly Adventure 06: More Subroutines and Bouncing Sprites"
date:       2018-12-21
excerpt:    "This time we'll improve the sprite demo with subroutines and let the sprites bounce off the screen boundaries"
tags:       [SNES Assembly Adventure, assembly, programming, SNES, tutorial]
feature:    /assets/snesaa/05/saa05_featurecard.png
published:  true
comments:   true
---
...
<figure>
    <a href="{{ "/assets/snesaa/05/saa05_titlecard.png" | uri_escape | absolute_url }}">
        <img src="{{ "/assets/snesaa/05/saa05_titlecard.png" | uri_escape | absolute_url }}">
    </a>
...
<figure>
    <a href="{{ "/assets/snesaa/05/saa05_stack_relative.png" | uri_escape | absolute_url }}">
        <img src="{{ "/assets/snesaa/05/saa05_stack_relative.png" | uri_escape | absolute_url }}">
    </a>
