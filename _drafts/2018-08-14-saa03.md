---
layout:     post
title:      "SNES Assembly Adventure 03: Your First Sprite"
date:       2018-08-14
...
<figure>
    ...
    <figcaption>Your Development Evironment Badge has evolved to the First Opcodes Badge!</figcaption>
</figure>
...
Now, repeat this for the other three tiles. One tile needs 32 bytes, so your final file should have a size of 128 bytes (crazy, I know! The favicon in your browser is larger than this). Save this as `Sprites.vra` in `/assemblyadventure/lesson03/` or wherever you prefer to keep your files. Mind that the file extension is arbitrary; I chose `.vra` to represent VRAM. Some choose `.rom` or `.bin`, it doesn't really matter. Just keep it consistent. You will need those files in the next article when we write the code to display them on the SNES.
