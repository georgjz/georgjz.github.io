...
{:.note}
:bulb: **Update January 2022**: Added build instructions for [Mesen-SX][mesensx] emulator. Updated build instructions for [bsnes+][bsnes_link]. Updated instructions to work with [MSYS2][msys2].

This is the first of several articles on developing games for the Super Nintendo Entertainment System. Retro Gaming has been strong in the past years, with hundreds of new games releases. Most aim to re-create the graphic and music style of so-called 8- or 16-bit consoles like The SNES or Sega Genesis/Mega Drive. But how were those classics made that so many of today's games try to emulate? The aim of these articles is to show you the steps for programming your own game for the SNES (and hopefully other consoles and machines in the future). We will cover all topics necessary for writing a SNES game from the beginning to the end. This article will kick-start your project by helping you to set up a development environment. Read on to start your own SNES Assembly Adventure.
