...
So, now we have our graphics data in `Sprites.vra` and the color palette in `SpriteColors.pal` ready to use. Congratulations, you have created your first SNES graphics!
...
I've written a [simple conversion tool][7] a while back. But I'm no longer actively working on it (Qt is just too weird for me). So here are some suggestions for other tools you can use.

Personally, I use [**Pro Motion NG**][cosmigo] by Cosmigo for my pixel art (if you can call it that...) as it also works great with graphic tablets. There's a free version you can [download here](https://www.cosmigo.com/pixel_animation_software/downloads). It is also [available on Steam](https://store.steampowered.com/app/671190/Pro_Motion_NG/). As of May 2022, Steam users can access the beta of version 8 (the current stable version in May 2022 is 7.2.7). Highly recommended.

A great open source alternative is [**Aseprite**][aseprite]. I use Aseprite before I switched to Pro Motion NG. In fact, all of the title cards, images, etc. you see in SNES Assembly Adventure articles were created with Aseprite originally. You can either download the [source code on Github](https://github.com/aseprite/aseprite/), [purchase it from their website](https://www.aseprite.org/#buy), or [get it on Steam](https://store.steampowered.com/app/431730/Aseprite/).

Aseprite also offers [great community support](https://community.aseprite.org). There is even this excellent tool/script specific for SNES developers:

<iframe width="560" height="315" src="https://www.youtube.com/embed/4ICXL0K8QUY" frameborder="0"> </iframe>

Find the download instructions in the video's description.

Here's an unordered list of other good tools:

* [GraphX2](http://grafx2.chez.com) is another great bitmap graphics tool with a retro feel to it
* [SuperFamiconv](https://github.com/Optiroc/SuperFamiconv) by Optiroc is a command line tool that will allow converting image files
* [Nesdoug's](https://github.com/nesdoug/M1TE2) allows you to create and edit tiles and tilemaps
...
* Here are some tools for converting graphics to a SNES format:
    ...
    * ~~I have written my [own tool][7]. It will take a single file and automatically convert it to a 4bpp and palette file. It's in a very early stage and by no end finished yet. Use at your own risk.~~ I'm no longer actively working on this.
