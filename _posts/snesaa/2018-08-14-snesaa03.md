...
### SNES Palettes
Since we're using color indexing, we need to store the actual color values somewhere. The sprite data and color data are stored in two separate files. Why that is will be part of the next article on the architecture of the SNES.
